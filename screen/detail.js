...
export default class DetailsScreen extends Component{
    ...
    setDetails = planetDetails=>{
        ...
        switch(planet_type){
            case "Gas Giant":
                imgpath=require("assests/gas_giant.png")
                break
            
            case "Terrestrial":
                imgpath=require("assests/terrestrial.png")
                break

            case "Super Earth":
                imgpath=require("assests/super_earth.png")
                break
                    
            case "Neptune Like":
                imgpath=require("assests/neptune_like.png")
                break        
